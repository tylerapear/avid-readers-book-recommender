...
model = pickle.load(open('avid-readers-book-recommender/artifacts/model.pkl', 'rb'))
books_name = pickle.load(open('avid-readers-book-recommender/artifacts/books_name.pkl', 'rb'))
book_pivot = pickle.load(open('avid-readers-book-recommender/artifacts/book_pivot.pkl', 'rb'))
final_rating = pickle.load(open('avid-readers-book-recommender/artifacts/final_rating.pkl', 'rb'))
